...
namespace Networking
{
    class proxyHandler
    {
        ...
        public proxyHandler(TcpClient socket)
        {
            ...
            Util.Terminal.WriteLine("new client connected. [" + socket.Client.RemoteEndPoint.ToString() + "]");
        }
            ...
            while (true)
            {
                ...
                while (serv.Connected)
                {
                    ...
                    if (serv.Connected && serv.Available != 0)
                    {
                        ...
                        Util.Terminal.WriteLine("ŽŽŽŽŽŽŽŽŽŽŽŽŽŽŽŽŽŽ" + "\r\n" + "SERVER: " + "\r\n" + "\r\n" + raw + "\r\n" + "\r\n");
            ...
            if (uri == "/")
            {
                if (ns.CanWrite)
                {
                    ...
                    foreach (string s in names)
                    {
                        ...
                        Util.Terminal.WriteLine(working);
